...
There is no executable permanent installation path. A
[design-only persistence/rollback plan](docs/PERSISTENCE_PLAN.md) requires separate
review and authorization before any system write. Kernel builds stay in `kernel/`, host
